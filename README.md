# genpark-3d-gaussian-splatting-radiance-reconstructor-skill
...
> **GenPark AI Agent Skill** -- 3D Gaussian splatting radiance field reconstructor (3DGS / PostShot style)
